...
public class Window extends JFrame{
	...
	public void colision(){
		if(Moto.getXmoto()==Bomb.getYitem() && Moto.getYmoto()==Bomb.getXitem()){
			temp=1;
		}
		else if(Moto.getXmoto()==Gas.getYitem() && Moto.getYmoto()==Gas.getXitem()){
			temp=5;
		}
		else if(Moto.getXmoto()==Invensible.getYitem() && Moto.getYmoto()==Invensible.getXitem()){
			temp=2;
		}
		else if(Moto.getXmoto()==Speed.getYitem() && Moto.getYmoto()==Speed.getXitem()){
			temp=3;
		}
		else if(Moto.getXmoto()==Speed.getYitem() && Moto.getYmoto()==Speed.getXitem()){
			temp=4;
