    ...
    public void create(){
    	...
    	for (int I = 0; I < XM; ++I) {
            for (int J = 0; J < YM; ++J) {
            	...
            	else if(I==Window.Invensible.getXitem() && J==Window.Invensible.getYitem()) {
            		this.SetValue(I, J, 4);
            	}
            	else if (I==Window.Bomb.getXitem() && J==Window.Bomb.getYitem()) {
            		this.SetValue(I, J, 4);
            	}
            	else if(I==Window.Speed.getXitem() && J==Window.Speed.getYitem()) {
            		this.SetValue(I, J, 4);
            	}
            	else if(I==Window.Gas.getXitem() && J==Window.Gas.getYitem()) {
            		this.SetValue(I, J, 4);
            	}
            	else if(I==Window.Gas1.getXitem() && J==Window.Gas1.getYitem()) {
            		this.SetValue(I, J, 4);
            	}else{
            		this.SetValue(I, J, 0);
            	}
